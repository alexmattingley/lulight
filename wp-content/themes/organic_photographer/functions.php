...
function presstrends_theme() {
	...
	$auth = 't2d3d7sqxo25wd4urk2g2yif1192f5vol';
...
add_image_size( 'featured-img', 900, 600, true ); // Featured Slides
add_image_size( 'product-thumb-small', 340, 220, true ); // Homepage Shop Thumbnails
add_image_size( 'product-thumb-large', 420, 420 ); // Shop Page Thumbnails
add_image_size( 'portfolio', 900, 900 ); // Portfolio Images
add_image_size( 'page-feature', 980, 540, true ); // Featured Page Image