<?php
/*
Template Name: Portfolio Two Column new two
*/
?>
...
<div class="container portfolio">
	...
	<div class="row holder-half">
		...
		<?php $wp_query = new WP_Query(array('cat'=>of_get_option('category_portfolio_two_new2'),'posts_per_page'=>of_get_option('postnumber_portfolio_two_new2'),'paged'=>$paged)); ?>
